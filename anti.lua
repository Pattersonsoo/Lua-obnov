...
local update_url = "https://raw.githubusercontent.com/Pattersonsoo/Lua-obnov/main/update.ini" -- тут тоже свою ссылку
local update_path = getWorkingDirectory() .. "/update.ini" -- и тут свою ссылку

local script_url = "https://github.com/Pattersonsoo/Lua-obnov/blob/main/anti.luac?raw=true" -- тут свою ссылку
